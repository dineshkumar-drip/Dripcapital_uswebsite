...
const team: TeamMember[] = [
  {
    ...
    bio: 'Previously at Deutsche Bank and Barclays Capital in structured trade finance. Stanford MBA. Built Drip Capital from zero to $9B+ funded, pioneering technology-driven trade finance for American SMBs.',
    linkedin: 'https://www.linkedin.com/in/pushkarmukewar/',
    photo: '/team/pushkar-mukewar.jpg',
    initials: 'PM',
    color: '#0B1F3A',
  },
  {
    ...
    bio: 'Leads Drip Capital\'s capital markets strategy and global partnership network. Deep expertise in structured finance and international trade credit across US and emerging markets.',
    linkedin: 'https://www.linkedin.com/in/karlboog/',
    photo: '/team/karl-boog.jpg',
    initials: 'KB',
    color: '#1B5FA0',
  },
  {
    ...
    bio: 'Drives Drip Capital\'s channel partnership ecosystem across the US. Builds relationships with brokers, accountants, and financial advisors who refer growing businesses to Drip Capital.',
    linkedin: 'https://www.linkedin.com/in/mattheske/',
    photo: '/team/matt-heske.jpg',
    initials: 'MH',
    color: '#00693A',
  },
  {
    ...
    bio: 'Oversees Drip Capital\'s collections and recovery operations with a customer-first approach. Ensures fair, transparent resolution processes that protect both businesses and investors.',
